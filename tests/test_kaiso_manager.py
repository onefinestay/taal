...
def test_change_instance_type_updated_values(
...
def test_change_instance_type_update_existing_values(
        session, bound_manager, change_instance_hierarchy):
    manager = bound_manager
    obj = change_instance_hierarchy
...
def test_change_instance_type_update_removed_values(
        session, bound_manager, change_instance_hierarchy):
    manager = bound_manager
    obj = change_instance_hierarchy
...
def test_change_instance_type_update_unknown_values(
        session, bound_manager, change_instance_hierarchy):
    manager = bound_manager
    obj = change_instance_hierarchy
